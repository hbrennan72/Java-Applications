...
* Project 8		  |
* *****************************************************************
* The code that follows was provided to me as part of this project
******************************************************************/
...
public class AccountApp
{
	public static void main(String args[])
	{
		...
		System.out.println("Checking: " + currency.format
				(checking.getBalance()));
		System.out.println("Savings:  " + currency.format
				(savings.getBalance()));
		System.out.println();
		...
		while (choice.equalsIgnoreCase("y"))
		{
			...
			// get input from user
			String accountType = v.getChoiceString("Checking or savings? " +
					"(c/s): ", "c", "s");
	...
	{
		double amount = v.getDoubleWithinRange
				("Amount?: ", 0, 10000);  // $10,000 limit
		System.out.println();
	...
	(MyValidator v, Balanceable account)
	{
